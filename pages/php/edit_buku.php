...
<?php 
    include "koneksi.php";
    $tampil = mysqli_query($koneksi, "SELECT * FROM tbl_buku inner join tbl_kategori on tbl_buku.id_kategori=tbl_kategori.id_kategori WHERE id_buku='$_GET[id_buku]'");
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="../../index.php" class="brand-link">
      <img src="../../dist/img/d.png" alt="Dede Saepulloh" class="brand-image img-circle elevation-3"
           style="opacity: .8">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" method="POST" action="update_buku.php" enctype="multipart/form-data">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <select name="id_kategori" class="form-control">
                      ...
                      <?php 
                          $tampil1 = mysqli_query($koneksi, "SELECT * FROM tbl_kategori");
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="pengarang" placeholder="Pengarang" value="<?php echo "$data[pengarang]"; ?>">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    <label>Cover</label>
                    <?="<img src='upload/".$data['cover']."'style='width:50px; height:49px;'>"?>
                    
                    <input type="hidden" class="form-control" name="old_cover" value="<?php echo "$data[cover]"; ?>"/>
