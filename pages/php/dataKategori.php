      ...
      <div class="row">
        <div class="col-12">
          <div class="card">
            <!-- /.card-header -->
            <div class="card-body">
              <table id="tkategori" class="table table-bordered table-hover">
                <thead>
                <tr align="center">
                  <th>No</th>
                  <th>Nama Kategori</th>
                ...
                <tr>
                    ...
                    <td class="project-actions text-center">
                          <a class="btn btn-info btn-sm" href="edit_kategori.php?id_kategori=<?php echo "$data[id_kategori]"; ?>">
                              <i class="fas fa-pencil-alt">
                              </i>
                              Edit
                          </a>
                          <a class="btn btn-danger btn-sm" href="delete_kategori.php?id_kategori=<?php echo "$data[id_kategori]"; ?>">
      ...
      <div class="modal fade" id="modal-lg">
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            ...
            <form role="form" method="POST" action="insert_kategori.php">
                <div class="card-body">
