...
<?php 
    include "koneksi.php";
    $tampil = mysqli_query($koneksi, "SELECT * FROM tbl_kategori WHERE id_kategori='$_GET[id_kategori]'");
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
      <a href="../../pages/php/profile.php" class="nav-link">About</a>
      </li>
    </ul>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
              ...
              <li class="nav-item">
                <a href="../../pages/php/dataKategori.php" class="nav-link active">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Kategori Input</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" method="POST" action="update_kategori.php">
                <div class="card-body">
                  <div class="form-group">
                    <label>Nama Kategori</label>
                    <input type="hidden" class="form-control" name="id_kategori" value="<?php echo "$data[id_kategori]"; ?>" />
                    <input type="text" class="form-control" name="kategori" placeholder="Nama Kategori" value="<?php echo "$data[nama_kategori]"; ?>" />
                  </div>
