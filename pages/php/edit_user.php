...
<?php 
    include "koneksi.php";
      $tampil = mysqli_query($koneksi, "SELECT * FROM tbl_admin WHERE id_admin='$_GET[id_admin]'");
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">User Input</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" method="POST" action="update_user.php">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="password" class="form-control" name="userpass" placeholder="Password" value="<?php echo "$data[password]"; ?>">
                  </div>
                  <div class="form-group">
                    <label>Nama</label>
                    <input type="text" class="form-control" name="nama" placeholder="Enter Name" value="<?php echo "$data[nama_admin]"; ?>">
                  </div>
